   ...
   <div id="header" class="container-fluid">
    ...
    <div id="body" class="container">
        ...
        <div class="container infomation-body">
            ...
            <form action="/update-account/{{ $user->id_user }}" method="POST">
                @csrf
                <div class="form-group">
                    <label for="exampleInputUser">Họ và tên</label>
                ...
                <div class="form-group">
                    ...
                    <input name="usename" value="{{$user->usename}}" type="text" class="form-control" id="exampleInputUser"  placeholder="Mã người dùng">
                </div>
                <div class="form-group">
                    <label for="exampleInputUser">Mật khẩu</label>
                    <input name="password" value="{{$user->password}}" type="text" class="form-control" id="exampleInputUser"  placeholder="Mã người dùng">
                </div>
                <div class="form-group">
