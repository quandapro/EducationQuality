    ...
    <div class="container infomation-body">
        ...
        <div class="row left-info">
            <table border="2" class="table table-hover">
                ...
                <tr>
                    <th scope="col" colspan=2><b>Tiêu chuẩn/<br>Tiêu chí</b></th>
                    @foreach ($programs as $program)
                    <th scope="col" ><a href="/view_TC_CSGD_programs/{{$program -> id_CSGD}}" id="create_course">Kết quả đánh giá</a></th>
                    @endforeach
                ...
                <tr>
                    <td>Tiêu chí 2.4</td>
                    <td>{{ $program -> tieuChi2_4 }}</td>
                </tr>
                <tr>
                    <td>Tiêu chí 2.5</td>
                    <td>{{ $program -> tieuChi2_5 }}</td>
                </tr>
                <tr>
                    <td>Tiêu chí 2.6</td>
                    <td>{{ $program -> tieuChi2_6 }}</td>
                </tr>
                <tr>
                    <td>Tiêu chí 2.7</td>
                    <td>{{ $program -> tieuChi2_7 }}</td>
                </tr>
                <tr>
                ...
                <tr>
                    <td>Tiêu chí 3.4</td>
                    <td>{{ $program -> tieuChi3_4 }}</td>
                </tr>
                <tr>
                    <td>Tiêu chí 3.5</td>
                    <td>{{ $program -> tieuChi3_5 }}</td>
                </tr>
                <tr>
                    <td>Tiêu chí 3.6</td>
                    <td>{{ $program -> tieuChi3_6 }}</td>
                </tr>
                <tr>
                ...
                <tr>
                    <td>Tiêu chí 4.4</td>
                    <td>{{ $program -> tieuChi4_4 }}</td>
                </tr>
                <tr>
                    <td>Tiêu chí 4.5</td>
                    <td>{{ $program -> tieuChi4_5 }}</td>
                </tr>
                <tr>
                    <td>Tiêu chí 4.6</td>
                    <td>{{ $program -> tieuChi4_6 }}</td>
                </tr>
                <tr>
                    <td>Tiêu chí 4.7</td>
                    <td>{{ $program -> tieuChi4_7 }}</td>
                </tr>
                <tr>
                ...
                <tr>
                    <td>Tiêu chí 5.6</td>
                    <td>{{ $program -> tieuChi5_6 }}</td>
                </tr>
                <tr>
                    <td>Tiêu chí 5.7</td>
                    <td>{{ $program -> tieuChi5_7 }}</td>
                </tr>
                <tr>
                    <td>Tiêu chí 5.8</td>
                    <td>{{ $program -> tieuChi5_8 }}</td>
                </tr>
                <tr>
                ...
                <tr>
                    <td>Tiêu chí 6.8</td>
                    <td>{{ $program -> tieuChi6_8 }}</td>
                </tr>
                <tr>
                    <td>Tiêu chí 6.9</td>
                    <td>{{ $program -> tieuChi6_9 }}</td>
                </tr>
                <tr>
                ...
                <tr>
                    <td>Tiêu chí 7.6</td>
                    <td>{{ $program -> tieuChi7_6 }}</td>
                </tr>
                <tr>
                    <td>Tiêu chí 7.7</td>
                    <td>{{ $program -> tieuChi7_7 }}</td>
                </tr>
                <tr>
                ...
                <tr>
                    <td>Tiêu chí 9.6</td>
                    <td>{{ $program -> tieuChi9_6 }}</td>
                </tr>
                <tr>
                    <td>Tiêu chí 9.7</td>
                    <td>{{ $program -> tieuChi9_7 }}</td>
                </tr>
                <tr>
                    <td>Tiêu chí 9.8</td>
                    <td>{{ $program -> tieuChi9_8 }}</td>
                </tr>
                <tr>
                    <td>Tiêu chí 9.9</td>
                    <td>{{ $program -> tieuChi9_9 }}</td>
                </tr>
                <tr>
