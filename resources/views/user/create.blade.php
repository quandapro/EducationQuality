    ...
    <div id="body" class="container">
        ...
        <div class="container infomation-body">
            <div class="row infomation-body-title">
                <h3 style="color: #2a73cc;">Thêm mới người dùng</h3>
            </div>
            <form action="/user-store" method="POST">
                @csrf
                <div class="form-group">
                    <label for="exampleInputUser">Tên người dùng</label>
                    <input name="full_name" value="" type="text" class="form-control" id="exampleInputUser"  placeholder="Mã người dùng">
                </div>
                <div class="form-group">
                    <label for="exampleInputUser">Tên đăng nhập</label>
                    <input name="usename" value="" type="text" class="form-control" id="exampleInputUser"  placeholder="Mã người dùng">
                </div>
                <div class="form-group">
                    <label for="exampleInputUser">Mật khẩu</label>
                    <input name="password" value="" type="text" class="form-control" id="exampleInputUser"  placeholder="Mã người dùng">
                </div>
                <div class="form-group">
