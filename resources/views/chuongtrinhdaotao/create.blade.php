                        ...
                        <ul class="navbar-nav mr-auto">
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                    <a href="/view_CSGD_programs" class="dropdown-item" >Kiểm định cơ sở giáo dục</a>
                                    <a href="/view_CTDT_programs" class="dropdown-item" >Kiểm định chương trình đào tạo </a>
                                </div>
                            </li>
                            <li class="nav-item">
...
<div id="body" class="container">
    ...
    <div class="container infomation-body">
        <div class="row infomation-body-title">
            <h3>Thêm chương trình đào tạo</h3>
        </div>
        <form action = "/view_CTDT_store_programs" method = "post">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="status" placeholder="Enter the date" name="ngayHetHan_kd">
            </div>
