    ...
    <div id="body" class="container">
        ...
        <div class="container infomation-body">
            <div class="row infomation-body-title">
                <h3>Kết quả kiểm định chất lượng CSGD</h3>
            </div>
            <div class="row left-info">
                <table border="2" class="table table-hover">
                    <thead>
                        <tr>
                            <th scope="col">Cơ sở giáo dục (CSGD)</th>
                            <th scope="col">Kết quả kiểm định</th>
                            <th scope="col">Văn bản cơ sở giáo dục phản hồi</th>
                            <th scope="col">Giấy chứng nhận KĐCLGD</th>
                        </tr>
                    </thead>
                    <tbody>
                        <tr>
                            <!-- <th scope="row">1</th> -->
                            <td id="name_edu">Trường Đại học Khoa học Xã hội và Nhân văn - Đại học Quốc gia Hà Nội</td>
                            <td id="res_edu">
                                <a href="page_quaility_item" target="_blank">Nghị quyết số&nbsp;01/NQ-HĐKĐCLGD</a>, ban hành ngày 18/7/2016
                            </td>
                            <td id="doc_edu">
                                <a href="http://cea.vnuhcm.edu.vn/images/upload/website-1/Ket-qua-KDCLGD/CV-phan-hoi-cua-CSGD/3a-Dong-y-NQ-Nhan-van.pdf" target="_blank">CSGD nhất trí với nội dung Nghị quyết&nbsp;</a>
                            </td>
                            <td id="paper_edu">
                                Được cấp
                                <a href="http://cea.vnuhcm.edu.vn/images/upload/website-1/Ket-qua-KDCLGD/Giay-chung-nhan/2016.01-GCN-KHXH-NV-DHQGHN-Copy-.jpg" target="_blank">Giấy chứng nhận<br> kiểm định chất lượng</a>
                                <span>có giá trị đến ngày 12/11/1016</span>
                            </td>
                        </tr>
                        <tr>
                            <!-- <th scope="row">1</th> -->
                            <td id="name_edu">Trường Đại học Ngoại ngữ - Đại học Quốc gia Hà Nội</td>
                            <td id="res_edu">
                                <a href="http://cea.vnuhcm.edu.vn/images/upload/website-1/Ket-qua-KDCLGD/Nghi-quyet-Hoi-dong/NQ-DHKHXHNV-DHQGHN.pdf" target="_blank">Nghị quyết số&nbsp;01/NQ-HĐKĐCLGD</a>, ban hành ngày 18/7/2016
                            </td>
                            <td id="doc_edu">
                                <a href="http://cea.vnuhcm.edu.vn/images/upload/website-1/Ket-qua-KDCLGD/CV-phan-hoi-cua-CSGD/3a-Dong-y-NQ-Nhan-van.pdf" target="_blank">CSGD nhất trí với nội dung Nghị quyết&nbsp;</a>
                            </td>
                        ...
                        <tr>
                            <!-- <th scope="row">1</th> -->
                            <td id="name_edu">Trường Đại học Kinh tế - Đại học Quốc gia Hà Nội</td>
                            <td id="res_edu">
                                <a href="http://cea.vnuhcm.edu.vn/images/upload/website-1/Ket-qua-KDCLGD/Nghi-quyet-Hoi-dong/NQ-DHKHXHNV-DHQGHN.pdf" target="_blank">Nghị quyết số&nbsp;01/NQ-HĐKĐCLGD</a>, ban hành ngày 18/7/2016
                            </td>
                            <td id="doc_edu">
