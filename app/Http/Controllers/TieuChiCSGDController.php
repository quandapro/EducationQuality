...
class TieuChiCSGDController extends Controller
{
    ...
    {
        $programs = DB::select('select * from tieuchi_CSGD');
        return  view('cosogiaoduc.tieuchi_csgd.update', compact('programs'));
    }
